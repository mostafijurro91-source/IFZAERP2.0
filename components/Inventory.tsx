         ...
         <table className="w-full text-left min-w-[1200px]">
            <thead className="bg-slate-900 text-white/50 text-[9px] font-black uppercase tracking-widest italic border-b border-white/5">
               <tr>
                  ...
                  <th className="px-6 py-5 text-center">ক্রয় (+)</th>
                  <th className="px-6 py-5 text-center text-rose-400">বিক্রয় (-)</th>
                  <th className="px-6 py-5 text-center">রিপ্লেস</th>
                  <th className="px-6 py-5 text-center text-emerald-400">রিটার্ন (🔙)</th>
                  <th className="px-6 py-5 text-center bg-white/5 text-emerald-400">বর্তমান স্টক</th>
                  <th className="px-6 py-5 text-right">অ্যাকশন</th>
               </tr>
            </thead>
            <tbody className="divide-y divide-slate-50 text-[13px] font-bold italic">
               {loading ? (
                 <tr><td colSpan={8} className="py-20 text-center animate-pulse text-slate-300 font-black uppercase italic tracking-[0.4em]">Node Data Synchronizing...</td></tr>
               ) : filtered.length === 0 ? (
                 <tr><td colSpan={8} className="py-20 text-center text-slate-300 font-black uppercase">কোনো রেকর্ড পাওয়া যায়নি</td></tr>
               ) : filtered.map((p, idx) => (
